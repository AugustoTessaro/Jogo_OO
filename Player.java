...
public class Player implements Movimentos 
{
    ...
    public void esteticaPlayer() // usando ImageIcon o metodo esteticaPlayer define a imegem do do jogador e com os getters (height e widht
    {
    ...
    public boolean Visibilidade_player() 
    {
